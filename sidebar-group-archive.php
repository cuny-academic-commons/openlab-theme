...
/* ]]> */</script>';
	...
	?>
	<div class="filter">
		<p><?php esc_html_e( 'Narrow down your search using the filters or search box below.', 'commons-in-a-box' ); ?></p>
		...
		<div class="archive-search">
			<h3 class="bold font-size font-14"><?php esc_html_e( 'Search', 'commons-in-a-box' ); ?></h3>
			<form method="get" class="form-inline btn-combo" role="form">
				<div class="form-group">
					<input id="search-terms" class="form-control" type="text" name="search" placeholder="<?php esc_attr_e( 'Enter keyword', 'commons-in-a-box' ); ?>" /><label class="sr-only" for="search-terms"><?php esc_html_e( 'Enter keyword', 'commons-in-a-box' ); ?></label><button class="btn btn-primary top-align" id="search-submit" type="submit"><i class="fa fa-search" aria-hidden="true"></i><span class="sr-only"><?php esc_html_e( 'Search', 'commons-in-a-box' ); ?></span></button>
				</div>
			</form>
