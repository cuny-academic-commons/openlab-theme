<div class="action-events">
	<div id="item-body">
		...
		<div id="bpeo-ical-download">
		    <h3><?php esc_html_e( 'Subscribe', 'commons-in-a-box' ); ?></h3>
		    <li><a class="bpeo-ical-link" href="<?php echo esc_url( $link ); ?>"><span class="icon"></span><?php esc_html_e( 'Download iCalendar file (Public)', 'commons-in-a-box' ); ?></a></li>
		</div>
	</div>
</div>
