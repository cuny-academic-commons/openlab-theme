		...
		<div id="split-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-split">
			...
			<form id="split_topic" class="form form-panel" name="split_topic" method="post" action="<?php the_permalink(); ?>">
				...
				<div class="bbp-form panel panel-default">
					...
					<div class="panel-heading"><?php printf( __( 'Split topic "%s"', 'bbpress' ), bbp_get_topic_title() ); ?></div>
				...
				<div class="bbp-submit-wrapper">
					<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit" name="bbp_merge_topic_submit" class="btn btn-primary submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
				</div>
