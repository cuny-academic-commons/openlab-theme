...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<li class="bbp-topic-title">
		...
		<a class="bbp-topic-permalink" href="<?php bbp_topic_permalink(); ?>">
					<span class="truncate-on-the-fly hyphenate" data-basevalue="80" data-minvalue="42" data-basewidth="451"><?php bbp_topic_title(); ?></span>
					<span class="original-copy hidden"><?php bbp_topic_title(); ?></span>
				</a>
