...
<div class="doc-content img-rounded edit-doc">
	...
	<form action="" method="post" class="form-group form-panel" id="doc-form">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><?php esc_html_e( 'New Doc', 'commons-in-a-box' ); ?></div>
			<div class="panel-body">
				...
				<div class="doc-content-wrapper">
					...
					<div id="doc-submit-options">
						...
						<?php if ( current_user_can( 'bp_docs_manage', $doc_id ) ) : ?><a class="delete-doc-button confirm" href="<?php bp_docs_delete_doc_link() ?>"><?php esc_html_e( 'Delete', 'commons-in-a-box' ); ?></a><?php endif ?>
					</div>
