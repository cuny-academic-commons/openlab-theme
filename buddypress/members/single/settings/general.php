...
<div id="item-body" role="main">
	...
	<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form form-panel" id="settings-form">
		...
		<div class="form-group settings-section current-pw-section">
			...
			<p class="description"><?php esc_html_e( 'Required to change email address or password.', 'commons-in-a-box' ); ?> <a class="underline" href="<?php echo site_url( add_query_arg( array( 'action' => 'lostpassword' ), 'wp-login.php' ), 'login' ); ?>" title="<?php _e( 'Password Lost and Found', 'commons-in-a-box' ); ?>"><?php _e( 'Lost your password?', 'commons-in-a-box' ); ?></a></p>
		</div>
